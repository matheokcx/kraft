...
export class ProjectService {
    public static async getAllUserProjects (filters: any, userId: number, onlyProcessingProjects: boolean): Promise<Project[]> {
    ...
    public static async editProject (data: ProjectInformations, projectId: number, userId: number): Promise<Project> {
        const coverFile: File | null = data.cover;
        const today: number = Date.now();
